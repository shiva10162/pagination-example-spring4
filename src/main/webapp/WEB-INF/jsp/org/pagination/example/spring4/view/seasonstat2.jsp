...
<head>
    <title>Basketball Season Statistics (Ajax)</title>
            ...
            <pg:pagination pparam="${pparam}" paginationResult="${paginationResult}">
                ...
                <jsp:attribute name="controlButton">
                    <div style="padding-top:10px;">
                        <span class="button"><form:button name="buttonAction" value="deleteButton" class="button">Delete</form:button></span>
                        <span class="button"><form:button name="buttonAction" value="addButton" class="button">Add</form:button></span>
                    </div>
                </jsp:attribute>
            </pg:pagination>
        </form:form>
